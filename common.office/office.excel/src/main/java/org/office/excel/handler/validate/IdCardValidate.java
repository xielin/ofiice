...
public class IdCardValidate implements ValidateHandler {
	...
	public Boolean parse(Object cellValue) {
		logger.info("IdCardValidate.parseValidate({})",cellValue);
		String IDStr = String.valueOf(cellValue);
	...
	public static boolean isDataFormat(String str) {
		logger.info("IdCardValidate.isDataFormat({})",str);
		boolean flag = false;
